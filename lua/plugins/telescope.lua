...
return {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sa', function()
        builtin.find_files { hidden = true, prompt_title = 'Search all files, inclding hidden' }
      ...
      vim.keymap.set('n', '<leader>e', builtin.buffers, { desc = '[S]earch Recent Files ("." for repeat)' })
